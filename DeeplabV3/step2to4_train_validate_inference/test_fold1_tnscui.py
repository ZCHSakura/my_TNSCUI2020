...
def largestConnectComponent(bw_img):
    ...
    for i in range(0, num):
        print('我在largestConnectComponent')
        print(i)
...
if __name__ == '__main__':
    ...
    # 路径设置
    img_path = r'G:/graduation project/TN-SCUI2020/my_code/1_or_data/image'
    mask_path = r'G:/graduation project/TN-SCUI2020/my_code/1_or_data/mask'
    fold_id = r'G:/graduation project/TN-SCUI2020/my_code/DeeplabV3/step2to4_train_validate_inference/test_result/TNSCUI/test_fold_7_1/train_valid_test_id.xlsx'

    # task_name
    task_name = r' '

    # cascade参数
    weight_c1 = r'G:/graduation project/TN-SCUI2020/reference/wawawa/weigh_and_id/TNSCUI/fold1_stage1_trained_on_size_256.pkl'
    weight_c2 = r'G:/graduation project/TN-SCUI2020/reference/wawawa/weigh_and_id/TNSCUI/fold1_stage2_trained_on_size_512.pkl'

    c1_size = 256
    c1_tta = True
    # False for no preprocessing to remove irrelevant areas
    orimg = False
    ...
    table = data_xlsx.sheet_by_name('test')
    fold_id_all = [table.cell_value(i, 0) for i in range(1, table.nrows)]
    test_img_list = get_filelist_frompath_tnscui(img_path, 'bmp', sample_id=fold_id_all)
    # test_img_list = [img_path + sep + i for i in fold_id_all]
    ...
    with torch.no_grad():
        ...
        model_cascade1.load_state_dict(torch.load(weight_c1)['state_dict'])
        if c1_tta:
        ...
        model_cascade2.load_state_dict(torch.load(weight_c2)['state_dict'])
        if c2_tta:
