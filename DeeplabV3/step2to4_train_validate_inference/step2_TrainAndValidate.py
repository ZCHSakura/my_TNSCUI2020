...
def main(config):
    ...
    if config.validate_flag:
        train, valid, test = get_fold_filelist(config.csv_file, K=config.fold_K, fold=config.fold_idx, validation=True, test_csv=config.result_path, validation_r=0.1)
    else:
        train, test = get_fold_filelist(config.csv_file, K=config.fold_K, fold=config.fold_idx, test_csv=config.result_path)
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', type=int, default=5)    # stage1:8;stage2:2
    parser.add_argument('--batch_size_test', type=int, default=30)  # stage1:30;stage2:25
    ...
    parser.add_argument('--lr_cos_epoch', type=int, default=400)  # cos退火的epoch数,一般就是总epoch数-warmup的数,为0或False则代表不使用
    ...
    parser.add_argument('--Task_name', type=str, default='test_lr_', help='DIR name,Task name')
    parser.add_argument('--cuda_idx', type=int, default=0)
    parser.add_argument('--DataParallel', type=bool, default=False)

    # data-parameters
    # parser.add_argument('--filepath_img', type=str, default='G:/graduation project/TN-SCUI2020/reference/wawawa/DDTI-dataset/2_preprocessed_data/stage1/p_image')
    # # parser.add_argument('--filepath_img', type=str, default='G:/graduation project/TN-SCUI2020/reference/wawawa/DDTI-dataset/2_preprocessed_data/stage2/p_image')
    # parser.add_argument('--filepath_mask', type=str, default='G:/graduation project/TN-SCUI2020/reference/wawawa/DDTI-dataset/2_preprocessed_data/stage1/p_mask')
    # # parser.add_argument('--filepath_mask', type=str, default='G:/graduation project/TN-SCUI2020/reference/wawawa/DDTI-dataset/2_preprocessed_data/stage2/p_mask')
    # parser.add_argument('--csv_file', type=str, default='G:/graduation project/TN-SCUI2020/reference/wawawa/DDTI-dataset/2_preprocessed_data/train.csv')
    parser.add_argument('--fold_K', type=int, default=7, help='folds number after divided')
    parser.add_argument('--fold_idx', type=int, default=1)

    parser.add_argument('--filepath_img', type=str, default='G:/graduation project/TN-SCUI2020/my_code/2_preprocessed_data/stage1/p_image')
    # parser.add_argument('--filepath_img', type=str, default='G:/graduation project/TN-SCUI2020/reference/wawawa/DDTI-dataset/2_preprocessed_data/stage2/p_image')
    parser.add_argument('--filepath_mask', type=str, default='G:/graduation project/TN-SCUI2020/my_code/2_preprocessed_data/stage1/p_mask')
    # parser.add_argument('--filepath_mask', type=str, default='G:/graduation project/TN-SCUI2020/reference/wawawa/DDTI-dataset/2_preprocessed_data/stage2/p_mask')
    parser.add_argument('--csv_file', type=str, default='G:/graduation project/TN-SCUI2020/my_code/2_preprocessed_data/train_test.csv')

    # result&save
    parser.add_argument('--result_path', type=str, default='./test_result/TNSCUI')
    ...
    parser.add_argument('--validate_flag', type=bool, default=True)    # 是否使用交叉验证集,如果没有则使用测试集做验证
