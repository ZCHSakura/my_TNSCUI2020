...
if __name__ == '__main__':
    ...
    # 路径设置
    img_path = r'G:/graduation project/TN-SCUI2020/reference/wawawa/DDTI-dataset/1_or_data/image'
    mask_path = r'G:/graduation project/TN-SCUI2020/reference/wawawa/DDTI-dataset/1_or_data/mask'
    fold_id = r'./test_result/DDTI/author/fold1_id.xlsx'

    # task_name
    task_name = r'Test DDTI'

    # cascade参数
    weight_c1 = r'./test_result/DDTI/stage1_5_1/models/best_unet_score.pkl'
    weight_c2 = r'./test_result/DDTI/stage2_5_1/models/best_unet_score.pkl'
